...
\codedataavailability{Code and data are available at \url{https://github.com/dougmcneall/augmented_emulator}} %% use this section when having data sets and software code available
